...
import math, time, helper_functions, datetime, os 
...
#North offset
NORTH_OFFSET = 8.70 #Value given from sensor compared to 0 North on compass 
...
def i2c(bus, address):
    ...
    #Changed
    corrected_angle = angle - NORTH_OFFSET 
    # Adjust if necessary
...
filename = "/home/pi/data/tests/wind_direction/wind_direction_%s.dat" % now.strftime("%Y_%m_%d")
...
# Run once... or if in test mode, run every 10 seconds during the interval
    for i in range (0, iterations):
        ...
        # Handle script output
            ...
            if test:
                helper_functions.output(False, line, "test_wind_direction")
            else:
                helper_functions.output(False, line, "wind_direction")
